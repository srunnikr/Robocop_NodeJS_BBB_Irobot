...
def return_func(type, value_1, value_2):
	...
	if type == 1:
		...
		drive(300,32768)
		ser.write(WAITDIST)
		high_byte, low_byte = compute( 600 )
		...
		drive(300,32768)
		ser.write(WAITDIST)
		high_byte, low_byte = compute( 700 )
		ser.write(chr(high_byte))
		ser.write(chr(low_byte))		
		turn('left',180)			
...
def main():
	...
	if function == 'sensor1':
	   ...
	   #    subprocess.call( ["mpack", "-s", "Intruder alert", "bbimage.jpg", "jeo1kim@gmail.com"] )
	  #	subprocess.call( ["mpack", "-s", "Intruder alert", "bbimage.jpg", "shk149@eng.ucsd.edu"] )
		subprocess.call( ["mpack", "-s", "Intruder alert", "bbimage.jpg", "srunnikr@eng.ucsd.edu", "&"] )
		time.sleep(5)
		a,b,c=readFile()
		a = int(a)
                b = int(b)
